...
pipeline {
	...
	environment {
		...
		GITHUB_URL ='https://github.com/microchip-pic-avr-examples/avr128db48-low-bom-mic-interface-using-opamp.git'
		BITBUCKET_URL = 'https://bitbucket.microchip.com/scm/ebe/avr128db48-low-bom-mic-interface-using-opamp.git'
